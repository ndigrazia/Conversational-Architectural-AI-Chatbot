# branch desde: https://github.com/tyleroneil72/chat-bot

Se toma como base este desarrollo de chatbot nodejs para usarlo como front-end y backend for front end.

* invocación a servicio rag en ves dez de a openAI.
* Se agrega oauth2/oidc
